...
struct custom_mutator {
   ...
   * @return The action (0-25).
   */
  void (*afl_custom_havoc_mutation_reward)(void *data,  const char *crash, size_t crash_size, const char *virgin_bits, size_t virgin_bits_size);
...
void        havoc_mutation_reward_py(void *, const char *, size_t, const char *, size_t);
