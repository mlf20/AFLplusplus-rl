...
struct custom_mutator {
   ...
   * @return The action (0-25).
   */
  void (*afl_custom_havoc_mutation_reward)(void *data,  const char *crash, size_t crash_size, unsigned int);
...
void        havoc_mutation_reward_py(void *, const char *, size_t, unsigned int);
